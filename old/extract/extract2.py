...
'''
version_num_begin = input('input begin version number: ')
version_num_end = input('input end version number: ')
user_name = input('input user name: ')
filter_repeat = input('filter repeat record ? [ y / n ]: ')
'''
# versionNumBegin = 30050   29076
# versionNumEnd = 30125   30750
# user_name = 'duanyaochang'
version_num_begin = 31398
version_num_end = 31398
user_name = 'duanyaochang'
filter_repeat = 'n'
