...
#     500,  'duanyaochang', 1242,r'http://192.168.200.232:8888/svn/CN/Develop/projects/branches/DEV2/cnweb_ss')

svn_log_command = 'svn log --limit {0} --search {1} -v {2}'
svn_command_format = svn_log_command.format(
    1000,  '1242',r'http://192.168.200.232:8888/svn/CN/Develop/projects/branches/DEV2/cnweb_ss')
